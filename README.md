...
# So, what is Brandon?
Brandon is a no-list to do list, where you enter your chores and the program chooses one at random.
...
Python 3.7. The executable build is on a version of pyinstall that the creator can't be bothered to look up right now.
